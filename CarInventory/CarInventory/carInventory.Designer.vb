...
Partial Class carInventory
    ...
    Private Sub InitializeComponent()
        ...
        Me.carInventoryToolTip.SetToolTip(Me.txtModel, "Please enter the car's model.")
        '
        'lblYear
        '
        ...
        Me.carInventoryToolTip.SetToolTip(Me.cmbMake, "Please select the car's make from the list.")
        '
        'cmbYear
        '
        ...
        Me.carInventoryToolTip.SetToolTip(Me.cmbYear, "Please select the car's year from the list." & Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10))
        '
        'lblPrice
        '
        ...
        Me.carInventoryToolTip.SetToolTip(Me.txtPrice, "Please enter the car's price.")
        '
        'chkNew
        '
        ...
        Me.carInventoryToolTip.SetToolTip(Me.chkNew, "Select this box if the car is new.")
        ...
        Me.carInventoryToolTip.SetToolTip(Me.btnEnter, "Submits the current entry.")
        ...
        Me.carInventoryToolTip.SetToolTip(Me.btnReset, "Resets input controls.")
        ...
        Me.carInventoryToolTip.SetToolTip(Me.btnExit, "Exits the program.")
        ...
        Me.carInventoryToolTip.SetToolTip(Me.lvwCars, "Displays a list of all the cars entered.")
